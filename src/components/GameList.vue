...
function setup(props) {
  ...
  const games = ref([
    ...
    { id: 6, name: "Memory span", style: `grid-row: row-3 / span 1; grid-column: col-1 / span 2; background-image: url(${require('@/assets/backgrounds/memory-span.jpg')});`, path:"/memorySpan" },
